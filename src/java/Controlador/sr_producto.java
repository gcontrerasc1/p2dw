...
public class sr_producto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p>" + request.getParameter("txt_idproducto") +"</p>");
            out.println("<p>" + request.getParameter("txt_producto") +"</p>");
            out.println("<p>" + request.getParameter("txt_idmarca") +"</p>");
            out.println("<p>" + request.getParameter("txt_descripcion") +"</p>");
            out.println("<p>" + request.getParameter("txt_costo") +"</p>");
            out.println("<p>" + request.getParameter("txt_venta") +"</p>");
